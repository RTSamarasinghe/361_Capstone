...
namespace Tests
{
    ...
    public class CustomerAccessorTests
    {
        ...
        {
            _insertedId = _accessor.AddCustomer("Test User", "test@example.com", "hashedpass", _cartId, null);
        ...
        {
            _insertedId = _accessor.AddCustomer("Test User", "test2@example.com", "hashedpass", _cartId, null);
        ...
        {
            _insertedId = _accessor.AddCustomer("Test User", "unique@example.com", "hashedpass", _cartId, null);
        ...
        {
            _insertedId = _accessor.AddCustomer("Test User", "test3@example.com", "hashedpass", _cartId, null);
        ...
        {
            _insertedId = _accessor.AddCustomer("Old Name", "test4@example.com", "hashedpass", _cartId, null);
        ...
        {
            _insertedId = _accessor.AddCustomer("Test User", "test5@example.com", "hashedpass", _cartId, null);
        ...
        {
            _insertedId = _accessor.AddCustomer("Test User", "test6@example.com", "hashedpass", _cartId, null);
        ...
        {
            int id = _accessor.AddCustomer("To Delete", "delete@example.com", "hashedpass", _cartId, null);

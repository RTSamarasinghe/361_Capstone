...
VALUES ('Dehydrated Water', 'Water that has been dehydrated to remove all moisture', 6.70, 1, 'Images/DehydratedWater.png', 'Nonsense Inc.', 4.5, 'DW-001', 100);
INSERT INTO Product (Name, Description, Price, CategoryId, ImageURL, Manufacturer, Rating, Sku, StockQuantity)
VALUES('Fireproof Matches', 'Matches that are fireproof, to prevent fires', 4.20, 1, 'Images/FireproofMatches.png', 'Nonsense Inc.', 1.4, 'FPM-001', 200);
INSERT INTO Product (Name, Description, Price, CategoryId, ImageURL, Manufacturer, Rating, Sku, StockQuantity)
VALUES('Silent Alarm Clock', 'An alarm clock that doesn''t make any noise', 17.38, 1, 'Images/SilentAlarmClock.png', 'Nonsense Inc.', 3.2, 'SAC-001', 150);
INSERT INTO Product (Name, Description, Price, CategoryId, ImageURL, Manufacturer, Rating, Sku, StockQuantity)
VALUES('Waterproof Sponges', 'Sponges that are waterproof and won''t absorb water', 9.11, 1, 'Images/WaterproofSponges.png', 'Nonsense Inc.', 2.8, 'WPS-001', 80);
INSERT INTO Product (Name, Description, Price, CategoryId, ImageURL, Manufacturer, Rating, Sku, StockQuantity)
...
INSERT INTO Product (Name, Description, Price, CategoryId, ImageURL, Manufacturer, Rating, Sku, StockQuantity)
VALUES('Shark NV3520', 'A compact vacuum cleaner with powerful suction and easy maneuverability', 129.99, 2, 'Images/SharkNV3520.png', 'Shark', 4.3, 'SHARK-NV3520', 60);
INSERT INTO Product (Name, Description, Price, CategoryId, ImageURL, Manufacturer, Rating, Sku, StockQuantity)
